...
def generate_scss(data):
  ...
  d = []
  d.append('// Google Icons Variables')
  d.append('// --------------------------\n')
...
def generate_component_json(data):
  ...
  d = {
    ...
    "description": "The premium Google icon font inspired on Ionicons.",
...
def generate_composer_json(data):
  ...
  d = {
    ...
    "keywords": [ "fonts", "icon font", "icons", "google", "web font"],
